...
public class SplashActivity extends AppCompatActivity {
    ...
    private void loadAmericanRecipes() {
        ...
        databaseAdapter.addNewRecipe(new Recipe("American pancakes",
                ...
                , ingredients, directions,"/storage/emulated/0/Pictures/FoodRecipes/Images/demo_american_pancakes.jpg"));
    }
    ...
    private void loadVeganRecipes() {
        ...
        databaseAdapter.addNewRecipe(new Recipe("Vegan sunflower",
                ...
                , ingredients, directions, "/storage/emulated/0/Pictures/FoodRecipes/Images/demo_vegan_sunflower.jpg"));
        ...
        databaseAdapter.addNewRecipe(new Recipe("Vegan vegetables",
                "Vegan", "Roasted Cauliflower and Brussels Sprouts", ingredients1, directions1, "/storage/emulated/0/Pictures/FoodRecipes/Images/demo_vegan_vegetables.jpg"));
    }

    private void loadEuropeanRecipes() {
        List<Ingredient> ingredients = new ArrayList<>();
        ...
        databaseAdapter.addNewRecipe(new Recipe("European lasagna",
                "European", "Classic Italian Lasagna", ingredients, directions, "/storage/emulated/0/Pictures/FoodRecipes/Images/demo_european_lasagna.jpg"));

    }

    private void loadMediterraneanRecipes(){
        List<Ingredient> ingredients = new ArrayList<>();
        ...
        databaseAdapter.addNewRecipe(new Recipe("Mediterranean steak",
                "Mediterranean", "This steak gets a wet rub before grilling; the oil helps the other flavors spread.", ingredients, directions,
                "/storage/emulated/0/Pictures/FoodRecipes/Images/demo_mediterranean_steak.jpg"));
    }

    private void loadAsianRecipes(){
        List<Ingredient> ingredients = new ArrayList<>();
        ...
        databaseAdapter.addNewRecipe(new Recipe("Asian chicken",
                "Asian", "Tender and juicy chicken breasts that get coated in a sticky sweet asian sauce.  This meal is ready in just thirty minutes and the flavor is awesome!", ingredients, directions,
                "/storage/emulated/0/Pictures/FoodRecipes/Images/demo_asian_chicken.png"));
    }
